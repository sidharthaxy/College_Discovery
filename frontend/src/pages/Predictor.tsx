    ...
    <div className="space-y-12 animate-fade-in max-w-4xl mx-auto">
      ...
      <div className="text-center space-y-3">
        ...
        <p className="text-slate-500 text-sm max-w-xl mx-auto font-medium">
          Enter your entrance exam details and rank to discover recommended Tier-1 colleges based on historical cutoff closing ranks.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="JEE Main">JEE Main (NITs)</option>
              </select>
            </div>
          ...
          {loading ? (
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-12 text-center shadow-sm">
              ...
              <p className="mt-2 text-xs text-slate-500 max-w-sm mx-auto leading-relaxed">
                Your rank exceeds the closing cutoffs for the seeded {exam} data. Try adjusting the seat category or rank input to test another option.
              </p>
            </div>
          ) : (
            <div className="space-y-3">
              {matches.map((match) => (
                ...
                >
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-slate-400 text-xs mt-1.5 font-medium">
                        ...
                        <span className="flex items-center gap-1 text-navy-900 font-bold bg-navy-50 px-2 py-0.5 rounded text-[10px] uppercase">
                          <GraduationCap className="w-3 h-3 text-navy-700" />
                          {match.branch}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="mt-4 sm:mt-0 flex sm:flex-col items-center sm:items-end justify-between sm:justify-center gap-2 border-t sm:border-t-0 border-slate-100 pt-3 sm:pt-0">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wide">
                      Historical Cutoff (Round {match.round})
                    </span>
